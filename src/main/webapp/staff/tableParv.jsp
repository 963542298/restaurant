...
<head>
	...
	<link rel="stylesheet" href="/restaurant/lib/layui/css/layui.css">
...
<script type="text/html" id="barDemo">
	<a class="layui-btn layui-btn-xs layui-btn-radius layui-btn-warm" lay-event="start" >启用</a>
</script>


<script src="/restaurant/lib/layui/layui.js" charset="utf-8"></script>
<script src="/restaurant/js/tableParv.js"></script>
