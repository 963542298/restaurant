...
<div class="layui-fluid">
    <form class="layui-form">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" lay-verify="" class="layui-input userBirthday" id="date">
            </div>
        </div>
        <div class="layui-form-item">
            <label  class="layui-form-label">
        ...
        <div class="layui-form-item">
            ...
            <div style="width: 340px; padding-left: 50px;">
                <button class="layui-btn layui-btn-lg layui-btn-radius layui-btn-normal layui-btn-fluid" lay-filter="userEdit" lay-submit="" type="button">
                    编辑
                </button>
            </div>
        </div>
