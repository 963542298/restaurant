				...
				table.on('tool(test)', function(obj) {
					...
					if(obj.event === 'start') {
						...
						function(index) {
							$.ajax({
								type:"post",
								url: "http://localhost:8080/restaurant/desk/updateTableState.action?tableState=1"+"&tableCode="+data.tableCode,
							});
							layer.close(index);
							location.href='table1.html?tableCode='+data.tableCode+'&timer='+timer;
						});
					} 
				});	
